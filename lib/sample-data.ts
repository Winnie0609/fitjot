...
const CATALOG = {
  ...
  chest: [
    { id: '1mcOhYXnVKkmbFTQnYuo', name: 'Barbell Bench Press - Medium Grip' },
...
export function getSampleWorkoutSessionsFor(
  uid: string
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          name: CATALOG.core[2].name,
          rpe: 9,
          // For plank, use seconds in the weight field to represent duration
          sets: [
